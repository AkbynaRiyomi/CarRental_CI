        ...
        <div class="table-responsive">
            <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                ...
                ?>
                    <tr>
                        <td><?php echo $no++; ?></td>
                        <td><?php echo $m->mobil_name ?></td>
                        <td><?php echo $m->user_id ?></td>
                        <td><?php echo $m->mobil_id ?></td>
                        <td><?php echo $m->tgl_ml ?></td>
                        <td><?php echo $m->tgl_selesai ?></td>
                        <td><?php echo $m->baret_sebelum ?></td>
                        <td>
                        <?php
                        if($m->mobil_status == 1){
                            echo 'Available';
